...
import com.appodeal.test.adapters.AppodealWrapperAdapter;
import com.appodeal.test.adapters.NativeAdapter;
...
public class NativeActivity extends FragmentActivity {
    ...
    private final Runnable addPackRunnable = this::addPackToAdapter;
